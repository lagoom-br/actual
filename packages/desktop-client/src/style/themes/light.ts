...
export const pageBackground = colorPalette.beige100;
export const pageBackgroundModalActive = colorPalette.navy200;
export const pageBackgroundTopLeft = colorPalette.beige100;
export const pageBackgroundBottomRight = colorPalette.beige100;
...
export const pageTextPositive = colorPalette.green600;
export const pageTextLink = colorPalette.navy600;
export const pageTextLinkLight = colorPalette.navy300;

export const cardBackground = colorPalette.white;
export const cardBorder = colorPalette.navy900;
...
export const tableTextLight = colorPalette.gray150;
...
export const tableHeaderText = colorPalette.black;
export const tableHeaderBackground = colorPalette.white;
export const tableBorder = colorPalette.navy100;
export const tableBorderSelected = colorPalette.navy800;
export const tableBorderHover = colorPalette.navy700;
export const tableBorderSeparator = colorPalette.navy400;
export const tableRowBackgroundHighlight = colorPalette.navy150;
...
export const sidebarItemAccentSelected = colorPalette.white;
export const sidebarItemText = colorPalette.lavendergrey;
export const sidebarItemTextSelected = colorPalette.white;
...
export const mobileHeaderBackground = colorPalette.navy700;
...
export const mobileNavItem = colorPalette.gray200;
export const mobileNavItemSelected = colorPalette.navy600;
export const mobileAccountShadow = colorPalette.navy300;
export const mobileAccountText = colorPalette.navy800;
export const mobileTransactionSelected = colorPalette.navy800;

// Mobile view themes (for the top bar)
export const mobileViewTheme = mobileHeaderBackground;
export const mobileConfigServerViewTheme = colorPalette.navy800;

export const markdownNormal = colorPalette.navy150;
export const markdownDark = colorPalette.navy600;
export const markdownLight = colorPalette.navy100;
...
export const buttonMenuSelectedBackground = colorPalette.beige700;
export const buttonMenuSelectedBackgroundHover = colorPalette.beige500;
...
export const buttonNormalSelectedBackground = colorPalette.navy600;
...
export const upcomingBackground = colorPalette.navy100;
export const upcomingText = colorPalette.navy900;
export const upcomingBorder = colorPalette.navy700;

export const formLabelText = colorPalette.navy600;
export const formLabelBackground = colorPalette.navy200;
export const formInputBackground = colorPalette.navy50;
export const formInputBackgroundSelected = colorPalette.white;
export const formInputBackgroundSelection = colorPalette.navy800;
export const formInputBorder = colorPalette.navy150;
export const formInputTextReadOnlySelection = colorPalette.navy50;
export const formInputBorderSelected = colorPalette.navy800;
...
export const formInputShadowSelected = colorPalette.navy300;
export const formInputTextHighlight = colorPalette.navy200;
export const checkboxText = tableBackground;
export const checkboxBackgroundSelected = colorPalette.navy700;
export const checkboxBorderSelected = colorPalette.navy700;
export const checkboxShadowSelected = colorPalette.navy300;
export const checkboxToggleBackground = colorPalette.gray400;
export const checkboxToggleBackgroundSelected = colorPalette.navy800;
...
export const pillTextHighlighted = colorPalette.navy800;
export const pillBorder = colorPalette.navy150;
export const pillBorderDark = colorPalette.navy300;
export const pillBackgroundSelected = colorPalette.navy150;
export const pillTextSelected = colorPalette.navy900;
export const pillBorderSelected = colorPalette.navy700;
...
export const noteTagBackground = colorPalette.navy100;
export const noteTagBackgroundHover = colorPalette.navy150;
export const noteTagText = colorPalette.navy700;

export const budgetCurrentMonth = tableBackground;
export const budgetOtherMonth = colorPalette.navy50;
export const budgetHeaderCurrentMonth = budgetOtherMonth;
export const budgetHeaderOtherMonth = colorPalette.gray80;

export const floatingActionBarBackground = colorPalette.navy700;
